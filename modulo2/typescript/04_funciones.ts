...
function sumarNun(x: number, y: number) {
  return x + y;
}

console.log(sumarNun(5, 3));       // 8  ✅
console.log(sumarNun(5, 3));     // "53"  😕 concatenó en lugar de sumar
console.log(sumarNun(5,8));          // NaN  😕 b es undefined
